...
const Navbar = () => {
  ...
  return (
    <header className="flex items-center justify-between p-4 bg-gray-800 text-white shadow-lg">
      ...
      <nav className={`flex-col items-center space-y-1 md:flex md:flex-row md:space-y-0 md:space-x-6 transition-all duration-300 absolute md:relative top-16 left-0 w-full md:w-auto bg-gray-800 md:bg-transparent ${isOpen ? 'flex' : 'hidden'} md:flex`}>
